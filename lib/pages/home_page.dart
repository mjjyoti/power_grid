...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    Timer.periodic(const Duration(seconds: 1, milliseconds: 300), (timer) {
      setState(() {
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const Heading2(title: 'Home'),
                            ],
                          ),
                          const Heading2(title: 'Battery')
                        ],
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: Image.asset(
                        'assets/battery.png',
                        fit: BoxFit.cover,
                        color: PowerGridColors.lightBlack.withOpacity(.85),
